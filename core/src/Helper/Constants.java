...
public class Constants {
    ...
    public static final float GROUND_HEIGHT = APP_HEIGHT/8f;
    ...
    public static final float RUNNER_WIDTH = APP_WIDTH/13f;
    public static final float RUNNER_HEIGHT = APP_HEIGHT/24f;
